			...
			<form name="form1" id="form1">		
				<?	if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td width="12%"><div align="center"><?php echo implota(mysql_result($res_resultado,$contador,"facturasp.fechapago"))?></div></td>
							<td width="12%"><div align="right"><?php echo number_format(mysql_result($res_resultado,$contador,"importe"),2)?></div></td>							
							...
							<td class="aDerecha" width="15%"><div align="center"><?php echo implota(mysql_result($res_resultado,$contador,"pagos.fechapago"))?></div></td>
					...
					<?php } else { ?>
					<div id="frame_cobros1">
					<table class="fuente8" width="106%" cellspacing=0 cellpadding=0 border=0>
						<tr>
							<td width="106%" class="mensajeNP"><?php echo "Todav&iacute;a no se ha producido ning&uacute;n pago en esta factura.";?></td>
					    </tr>
					</table></div>					
					<?php } ?>	
					</form>				
