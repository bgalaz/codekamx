			...
			<input type="hidden" name="numfilas" id="numfilas" value="<?php echo $filas?>">
				<?	if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							<td class="aCentro" width="5%"><input type="checkbox" name="checkbox_socio" id="checkbox_socio" value="<?php echo mysql_result($res_resultado,$contador,"codfactura")?>" style="border:0"></td>
							...
							<td width="21%"><div align="left"><?php echo mysql_result($res_resultado,$contador,"nombre")?></div></td>							
							<td width="9%"><div align="right"><?php echo number_format(mysql_result($res_resultado,$contador,"totalfactura"),2,".",",")?></div></td>
							...
							<td class="aDerecha" width="10%"><div align="right"><?php echo number_format($pendiente,2,".",",")?></div></td>
