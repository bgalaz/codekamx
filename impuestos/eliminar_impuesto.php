...
<html>
	<head>
		...
		function aceptar(codimpuesto) {
			location.href="guardar_impuesto.php?codimpuesto="+codimpuesto+"&accion=baja"+"&cadena_busqueda=<?php echo $cadena_busqueda?>";
		}
		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<div id="botonBusqueda">
					<img src="../img/botonaceptar.jpg" width="85" height="22" onClick="aceptar(<?php echo $codimpuesto?>)" border="1" onMouseOver="style.cursor=cursor">
