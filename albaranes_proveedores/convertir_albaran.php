	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">CONVERTIR GUIA DE DESPACHO</div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="guardar_albaran.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						<tr>
							<td width="14%">C&oacute;digo Guia de Despacho</td>
						    <td width="36%"><?php echo $codalbaran?></td>
				            <td width="50%"><ul id="lista-errores"></ul></td>
						</tr>
						<tr>
							<td width="14%">Proveedor</td>
						    <td width="36%"><?php echo $nombre_proveedor?></td>
				            <td width="50%"></td>
						</tr>
						<tr>
						...
						<tr>
						    ...
						    <td width="36%"><input NAME="fecha" type="text" class="cajaPequena" id="fecha" size="10" maxlength="10" value="<?php echo $fecha?>" readonly> <img src="../img/calendario.png" name="Image1" id="Image1" width="16" height="16" border="0" id="Image1" onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
				...
				<div id="botonBusqueda">
					...
					<input id="codproveedor" name="codproveedor" value="<?php echo $codproveedor?>" type="hidden">
			  </div>
			  </form>
			 </div>
		  </div>
