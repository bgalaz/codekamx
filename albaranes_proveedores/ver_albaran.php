		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<div id="frmBusqueda">
					...
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
					  <?php $sel_lineas="SELECT * FROM albalineap,articulos WHERE albalineap.codalbaran='$codalbaran' AND albalineap.codproveedor='$codproveedor' AND albalineap.codigo=articulos.codarticulo AND albalineap.codfamilia=articulos.codfamilia ORDER BY albalineap.numlinea ASC";
			  ...
			  <?php $baseimpuestos=$baseimponible*($iva/100);
				...
				<div id="botonBusqueda">
					...
					<img src="../img/botonaceptar.jpg" width="85" height="22" onClick="aceptar()" border="1" onMouseOver="style.cursor=cursor">
					 <img src="../img/botonimprimir.jpg" width="79" height="22" border="1" onClick="imprimir('<?php echo $codalbaran?>','<?php echo $codproveedor?>')" onMouseOver="style.cursor=cursor">
				        </div>
					</div>
			  </div>
		  </div>
