			  ...
			  <?php if ($accion=="baja") { 
				...
				<div id="botonBusqueda">
					<div align="center">
					  ...
					  <?php if ($accion<>"baja") { ?>
						   <?php if ($accion=="convertir") { ?>
						   <img src="../img/botonimprimir.jpg" width="79" height="22" border="1" onClick="imprimirf('<?php echo $codfactura?>',<?php echo $codproveedor ?>)" onMouseOver="style.cursor=cursor">
						   <?php } else { ?>
