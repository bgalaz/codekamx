...
<html>
	<head>
		...
		function facturar_albaran() {
			...
			if (opciones==0)  {
				alert("No hay guia despacho seleccionados.");
			} else {
				if (confirm("Va a facturar "+opciones+" guia despacho. Desea continuar?")) {
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">Facturar guia despacho </div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="rejilla.php" target="frame_rejilla">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						...
						<tr>
						  <td>Num. guia despacho Inicial</td>
        ...
        <script type="text/javascript">
					...
					button     : "Image1"
						...
						<tr>
						  <td>Fecha de fin</td>
						  <td><input id="fechafin" type="text" class="cajaPequena" NAME="fechafin" maxlength="10" value="<?php echo $fechafin?>" readonly><img src="../img/calendario.png" name="Image2" id="Image2" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'" title="Calendario2">
        <script type="text/javascript">
					Calendar.setup(
					  {
					inputField : "fechafin",
