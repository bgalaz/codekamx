		...
		<div id="pagina">
			...
			<input type="hidden" name="numfilas" id="numfilas" value="<?php echo $filas?>">
				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						<?php $sel_resultado="SELECT codalbaran,proveedores.nombre as nombre,albaranesp.fecha as fecha,totalalbaran FROM albaranesp,proveedores WHERE albaranesp.estado=1 AND albaranesp.codproveedor=proveedores.codproveedor AND ".$where;
						...
						<tr class="<?php echo $fondolinea?>">
							<td class="aCentro" width="10%"><input type="checkbox" name="checkbox_socio" id="checkbox_socio" value="<?php echo mysql_result($res_resultado,$contador,"codalbaran")?>" style="border:0"></td>
							<td class="aCentro" width="15%"><?php echo $contador+1;?></td>
							<td width="25%"><div align="center"><?php echo mysql_result($res_resultado,$contador,"codalbaran")?></div></td>
							<td width="25%"><div align="center"><?php echo number_format(mysql_result($res_resultado,$contador,"totalalbaran"),2,".",",")?></div></td>							
							<td class="aDerecha" width="25%"><div align="center"><?php echo implota(mysql_result($res_resultado,$contador,"fecha"))?></div></td>
						</tr>
						<?php $contador++;
							}
						?>			
