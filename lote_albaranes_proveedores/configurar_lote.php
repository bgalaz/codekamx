					...
					<?php $totalfactura=$totalfactura+mysql_result($rs_albaranes,$contador,"totalalbaran");
					   $contador++;
						...
						<tr>
						    ...
						    <td width="15%"><input NAME="fecha" type="text" class="cajaPequena" id="fecha" size="10" maxlength="10" value="<?php echo $hoy?>" readonly> <img src="../img/calendario.png" name="Image1" id="Image1" width="16" height="16" border="0" id="Image1" onMouseOver="this.style.cursor='pointer'">
