...
$rs_lineas=mysql_query($sel_lineas);
				...
				<div id="botonBusqueda">
					<div align="center">
					  ...
					  <img src="../img/caja.jpg" width="80" height="77" border="1" onClick="efectuarpago(<?php echo $codfactura?>,<?php echo $codcliente?>,<?php echo $preciototal?>)" onMouseOver="style.cursor=cursor" title="Efectuar pago">
				        </div>
					</div>
			  </div>
		  </div>
