			      ...
			      $preciototal=number_format($preciototal,2,".",",");
					...
					<table width="25%" border=0 align="right" cellpadding=3 cellspacing=0 class="fuente8">
						<tr>
							...
							<td width="15%"><?php echo $simbolomoneda ?><?php echo number_format($baseimponible,2,".",",");?></td>
						</tr>
						<tr>
							<td width="15%">IVA</td>
							<td width="15%"><?php echo $simbolomoneda ?><?php echo number_format($baseimpuestos,2,".",",");?></td>
						</tr>
						<tr>
							<td width="15%">Total</td>
							<td width="15%"><?php echo $simbolomoneda ?><?php echo $preciototal?></td>
						</tr>
					</table>
			  </div>
