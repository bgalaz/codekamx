...
<html>
	<head>
		...
		function aceptar(codubicacion) {
			location.href="guardar_ubicacion.php?codubicacion=" + codubicacion + "&accion=baja" + "&cadena_busqueda=<?php echo $cadena_busqueda?>";
		}
		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<div id="botonBusqueda">
					<img src="../img/botonaceptar.jpg" width="85" height="22" onClick="aceptar(<?php echo $codubicacion?>)" border="1" onMouseOver="style.cursor=cursor">
