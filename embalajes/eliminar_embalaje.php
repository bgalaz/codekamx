...
<html>
	<head>
		...
		function aceptar(codembalaje) {
			location.href="guardar_embalaje.php?codembalaje=" + codembalaje + "&accion=baja" + "&cadena_busqueda=<?php echo $cadena_busqueda?>";
		}
		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<div id="botonBusqueda">
					<img src="../img/botonaceptar.jpg" width="85" height="22" onClick="aceptar(<?php echo $codembalaje?>)" border="1" onMouseOver="style.cursor=cursor">
