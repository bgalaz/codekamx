					...
					button     : "Image1"
					  ...
					  <tr>
						 <td>Preguntar precio ticket</td>
						  ...
						  <?php if (mysql_result($rs_query,0,"precio_ticket")==0) { ?> 
						  <option value="0" selected="selected">No</option>
						  <option value="1">Si</option>
						  <?php } else { ?>
						   <option value="0">No</option>
					  ...
					  <tr>
						 <td>Modificar descrip. en ticket</td>
						  <td colspan="2"><select name="amodif_descrip" id="modif_descrip" class="comboPequeno">
						   <?php if (mysql_result($rs_query,0,"modificar_ticket")==0) { ?>
						  <option value="0" selected="selected">No</option>
						  <option value="1">Si</option>
						  <?php } else { ?>
						  <option value="0">No</option>
					  ...
					  <tr>
                        ...
                        <td width="20%" align="left" valign="top"><img src="../fotos/<?php echo mysql_result($rs_query,0,"imagen")?>" width="160px" height="140px" border="1"></td>
					  </tr>
                      -->
