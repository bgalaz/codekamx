					...
					<div id="frmBusqueda">
						...
						<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data"> 
							<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
								<tr>
									<td width="24%">Imagen del articulo: </td>
									<td>
										<input name="foto" type="file" id="foto"  accept="image/jpg"> 
									</td>
									<td>
										<input name="submit" type="submit" value="Ingresar Imagen" onclick="alert('La imagen ha sido cargada al servidor.'); location.reload(true)">
						...
						<form id="formulario" name="formulario" method="post" action="guardar_articulo.php" enctype="multipart/form-data">
							...
							<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
								...
								<tr>
									...
									<td><input NAME="qprecio_compra" type="text" class="cajaPequena" id="precio_compra" size="10" maxlength="10"> <?php echo $simbolomoneda ?></td></td>
								</tr>
								<tr>
									<td>Precio de almac&eacute;n</td>
									<td><input NAME="qprecio_almacen" type="text" class="cajaPequena" id="precio_almacen" size="10" maxlength="10"> <?php echo $simbolomoneda ?></td></td>
								</tr>
								<tr>
									<td>Precio de tienda</td>
									<td><input NAME="qprecio_tienda" type="text" class="cajaPequena" id="precio_tienda" size="10" maxlength="10"> <?php echo $simbolomoneda ?></td></td>
								</tr>
								<tr>
									<td>Precio con iva</td>
									<td><input NAME="qprecio_iva" type="text" class="cajaPequena" id="precio_iva" size="10" maxlength="10"> <?php echo $simbolomoneda ?></td></td>
								</tr>
								<tr>
