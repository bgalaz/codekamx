	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				...
				<div id="frmBusqueda">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						<tr>
					        ...
					        <td width="40%" rowspan="11" align="center" valign="top"><img src="../fotos/<?php echo mysql_result($rs_query,0,"imagen")?>" width="160px" height="140px" border="1"></td>
						</tr>
						<tr>
					...
					<?php
					  ...
					  ?>
						...
						<tr>
							...
							<td colspan="2"><?php echo mysql_result($rs_query,0,"precio_compra")?> <?php echo $simbolomoneda ?></td>
						</tr>
						<tr>
							<td>Precio almac&eacute;n</td>
							<td colspan="2"><?php echo mysql_result($rs_query,0,"precio_almacen")?> <?php echo $simbolomoneda ?></td>
						</tr>												
						<tr>
							<td>Precio en tienda</td>
							<td colspan="2"><?php echo mysql_result($rs_query,0,"precio_tienda")?> <?php echo $simbolomoneda ?></td>
						</tr>
						<!--<tr>
							<td>Pvp</td>
							<td colspan="2"><?php echo mysql_result($rs_query,0,"precio_pvp")?> <?php echo $simbolomoneda ?></td>
						</tr>-->
						<tr>
							<td>Precio con iva</td>
							<td colspan="2"><?php echo mysql_result($rs_query,0,"precio_iva")?> <?php echo $simbolomoneda ?></td>
						</tr>
							<tr>
				...
				<img src="../img/botonaceptar.jpg" width="85" height="22" onClick="aceptar(<?php echo $codarticulo?>)" border="1" onMouseOver="style.cursor=cursor">
