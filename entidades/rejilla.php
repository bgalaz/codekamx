				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td width="20%"><div align="center"><?php echo mysql_result($res_resultado,$contador,"codentidad")?></div></td>
							<td width="50%"><div align="left"><?php echo mysql_result($res_resultado,$contador,"nombreentidad")?></div></td>
