				...
				<form id="formulario" name="formulario" method="post" action="guardar_entidad.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
						    ...
						    <td width="43%"><input NAME="Anombreentidad" type="text" class="cajaGrande" id="nombreentidad" size="45" maxlength="45" value="<?php echo mysql_result($rs_query,0,"nombreentidad")?>"></td>
				        </tr>
					</table>
			  </div>
