					...
					if ($filas > 0) { ?>
						<?php $sel_resultado="SELECT codfactura,clientes.nombre as nombre,facturas.fecha as fecha,totalfactura,estado FROM facturas,clientes WHERE facturas.borrado=0 AND facturas.codcliente=clientes.codcliente AND ".$where;
						   ...
						   while ($contador < mysql_num_rows($res_resultado)) { 
								...
								<td width="6%"><div align="center"><a href="#"><img src="../img/modificar.png" width="16" height="16" border="0" onClick="modificar_factura(<?php echo mysql_result($res_resultado,$contador,"codfactura")?>,<?php echo $marcaestado?>)" title="Modificar"></a></div></td>
