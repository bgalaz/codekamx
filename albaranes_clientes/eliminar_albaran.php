...
<html>
	<head>
		...
		function aceptar(codalbaran) {
			location.href="guardar_albaran.php?codalbaran=" + codalbaran + "&accion=baja" + "&cadena_busqueda=<?php echo $cadena_busqueda?>";
		}
...
$rs_lineas=mysql_query($sel_lineas);
			  ...
			  <?php $baseimpuestos=$baseimponible*($iva/100);
				...
				<div id="botonBusqueda">
					<div align="center">
					<img src="../img/botonaceptar.jpg" width="85" height="22" onClick="aceptar(<?php echo $codalbaran?>)" border="1" onMouseOver="style.cursor=cursor">
