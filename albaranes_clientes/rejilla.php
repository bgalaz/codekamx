				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td width="8%"><div align="center"><?php echo mysql_result($res_resultado,$contador,"codalbaran")?></div></td>
							<td width="29%"><div align="left"><?php echo mysql_result($res_resultado,$contador,"nombre")?></div></td>
							<td width="10%"><div align="right"><?php echo number_format(mysql_result($res_resultado,$contador,"totalalbaran"),2,".",",")?></div></td>							
							...
							<td width="5%"><div align="center"><a href="#"><img src="../img/modificar.png" width="16" height="16" border="0" onClick="modificar_albaran(<?php echo mysql_result($res_resultado,$contador,"codalbaran")?>,<?php echo $marcaestado?>)" title="Modificar"></a></div></td>
							...
							<td width="5%"><div align="center"><a href="#"><img src="../img/eliminar.png" width="16" height="16" border="0" onClick="eliminar_albaran(<?php echo mysql_result($res_resultado,$contador,"codalbaran")?>,<?php echo $marcaestado?>)" title="Eliminar"></a></div></td>
							<td width="5%"><div align="center"><a href="#"><img src="../img/convertir.png" width="16" height="16" border="0" onClick="convertir_albaran(<?php echo mysql_result($res_resultado,$contador,"codalbaran")?>,<?php echo $marcaestado?>)" title="Facturar"></a></div></td>
