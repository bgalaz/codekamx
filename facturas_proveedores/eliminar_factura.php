...
<html>
	<head>
		...
		function aceptar(codfactura,codproveedor) {
			location.href="guardar_factura.php?codfactura=" + codfactura + "&codproveedor=" + codproveedor + "&accion=baja" + "&cadena_busqueda=<?php echo $cadena_busqueda?>";
		}
		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<div id="frmBusqueda">
					...
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
					  <?php $sel_lineas="SELECT * FROM factulineap,articulos WHERE factulineap.codfactura='$codfactura' AND factulineap.codproveedor='$codproveedor' AND factulineap.codigo=articulos.codarticulo AND factulineap.codfamilia=articulos.codfamilia ORDER BY factulineap.numlinea ASC";
$rs_lineas=mysql_query($sel_lineas);
						for ($i = 0; $i < mysql_num_rows($rs_lineas); $i++) {
							...
							if ($i % 2) { $fondolinea="itemParTabla"; } else { $fondolinea="itemImparTabla"; } ?>
									<tr class="<?php echo $fondolinea?>">
										...
										<td width="21%"><?php echo $referencia?></td>
			  ...
			  <?php $baseimpuestos=$baseimponible*($iva/100);
				...
				<div id="botonBusqueda">
					<div align="center">
					<img src="../img/botonaceptar.jpg" width="85" height="22" onClick="aceptar('<?php echo $codfactura?>',<?php echo $codproveedor?>)" border="1" onMouseOver="style.cursor=cursor">
