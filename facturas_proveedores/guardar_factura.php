			      ...
			      ?>
					...
					<table width="25%" border=0 align="right" cellpadding=3 cellspacing=0 class="fuente8">
						<tr>
							...
							<td width="25%"><?php echo $simbolomoneda ?> <?php echo number_format($baseimponible,0,",",".");?>&nbsp&nbsp&nbsp</td>
						</tr>
						<tr>
							<td width="35%"><b>IVA</b></td>
							<td width="25%"><?php echo $simbolomoneda ?> <?php echo number_format($baseimpuestos,0,",",".");?>&nbsp&nbsp&nbsp</td>
						</tr>
						<tr>
							<td width="35%"><b>Total</b></td>
							<td width="25%"><?php echo $simbolomoneda ?> <?php echo number_format($preciototal,0,",",".");?>&nbsp&nbsp&nbsp</td>
						</tr>
					</table>
			  </div>
			  <?php if ($accion=="baja") { 
