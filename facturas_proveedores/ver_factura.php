						...
						for ($i = 0; $i < mysql_num_rows($rs_lineas); $i++) {
							...
							if ($i % 2) { $fondolinea="itemParTabla"; } else { $fondolinea="itemImparTabla"; } ?>
									<tr class="<?php echo $fondolinea?>">
										...
										<td width="8%" class="aCentro"><?php echo number_format($importe,2) ?></td>
									</tr>
			  ...
			  <?php $baseimpuestos=$baseimponible*($iva/100);
				...
				<div id="botonBusqueda">
					...
					<img src="../img/botonaceptar.jpg" width="85" height="22" onClick="aceptar()" border="1" onMouseOver="style.cursor=cursor">
					 <img src="../img/botonimprimir.jpg" width="79" height="22" border="1" onClick="imprimir('<?php echo $codfactura?>','<?php echo $codproveedor?>')" onMouseOver="style.cursor=cursor">
				        </div>
					</div>
			  </div>
		  </div>
